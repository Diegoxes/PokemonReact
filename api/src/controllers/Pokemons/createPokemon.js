...
module.exports = async (dataPokemon) => {
    ...
    let { name, image, hp, attack, defense, speed, weight, height, typeIds } = dataPokemon;//contruccion del objeto pokemon
    ...
    const newPokemon = await createPokemon(pokemon);//helper 
